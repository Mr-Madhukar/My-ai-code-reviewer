...
function PullRequestRow({
  ...
  return (
    <div className="flex flex-col gap-2 border-b border-border/40 py-4 last:border-b-0 last:pb-0 first:pt-0">
      <div className="flex flex-wrap items-center gap-2">
        <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-green-500/15">
          <GitPullRequestIcon className="size-3.5 text-green-400" />
        </div>
        <Link
      ...
      <CardHeader>
        <CardTitle className="flex flex-wrap items-center gap-2 text-sm">
          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-blue-500/15">
            <FolderGit2Icon className="size-3.5 text-blue-400" />
          </div>
          {repo.repoFullName}
